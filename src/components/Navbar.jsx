...
const navbarLinks = [
  { label: "Beranda", href: "/#home", ariaLabel: "Beranda" },
  { label: "Harga", href: "/#pricing", ariaLabel: "Harga" },
...
export const Navbar = () => {
  ...
  return (
    <nav className="w-full h-20 flex flex-col justify-center items-center fixed md:bg-opacity-90 lg:bg-opacity-100 bg-opacity-90 z-40 lg:backdrop-blur-xl" aria-label="Main navigation">
      <div className="2xl:w-[1280px] xl:w-10/12 w-11/12 flex justify-between items-center relative">
        ...
        >
          <a href="/#home" aria-label="Home">
            <div className="flex justify-start items-center grow basis-0">
              ...
              <div className="bg-clip-text text-transparent bg-gradient-to-r from-[#4895D1] to-[#78B1E5] font-['Inter'] font-bold text-xl">
                REXDEV
              </div>
            </div>
          </a>
        ...
        >
          <div className="grow basis-0 justify-end hidden lg:flex">
            <a className="text-white main-border-gray rounded-xl bg-bgDark2 hover:bg-bgDark3  border-gray-700 pl-6 pr-8 pt-2 pb-2 text-sm flex" href="https://yanuar-ardhika.vercel.app/" target="_blank" aria-label="source code">
              <span className="pt-px">My Portofolio</span>
            </a>
          </div>
        </motion.div>
        <div
